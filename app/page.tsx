  ...
  return (
    <div className="flex justify-center items-center h-screen bg-cover bg-top bg-[url('/home-background.png')]">
      <div className="absolute top-0 left-0 w-12 h-12 bg-white rounded-lg shadow-lg"></div>
			<div className="flex flex-col items-center bg-white bg-opacity-80 p-8 sm:p-12 rounded-lg shadow-lg fixed w-[90%] sm:w-[90%] md:w-[80%] lg:w-[70%] h-1/2 lg:h-[70%]" >
      <h1 className="text-3xl sm:text-4xl font-bold mb-4">Thank you for coming !!!</h1>
      <div className="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-6 py-4 my-6 w-full" role="alert">
